		        ...
		        <div class="col-lg-12">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <!-- Form lọc -->
								<form action="customer_report" method="get" class="mb-4 p-3 border rounded shadow-sm bg-light">
		                        ...
		                        <tbody>
									<%
									    for (int i = 0; i < list.size(); i++) {
									       	customer_report cr = list.get(i);  // Giả sử list là List<BookingReport>
									%>
									    <tr>
									        <td><%= i + 1 %></td>
							...
							<form action="customer_report" method="post" class="mb-2 p-3">
